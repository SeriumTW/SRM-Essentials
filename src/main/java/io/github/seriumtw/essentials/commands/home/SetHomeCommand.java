package io.github.seriumtw.essentials.commands.home;
...
public class SetHomeCommand extends AbstractPlayerCommand {
    ...
    private static class SetHomeNamedCommand extends AbstractPlayerCommand {
        ...
        protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store,
            ...
            doSetHome(context, store, ref, playerRef, world, homeName, homeManager, SRMEssentials.getInstance().getMessageManager());
        }
    }
}
